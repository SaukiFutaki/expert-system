...
// import { redirect } from "next/navigation";
// import { firstCondition, fourthCondition, secondCondition, thirdCondition } from "@/schema/condition";
// import { generatePrompt } from '@/app/sauki/lib';
// import { useChat } from 'ai/react';
// import {  IFormData } from './../../app/sauki/page';
...
//   return { success: true, message: "New history created successfully" };
// };

// const saveCondition = async (table: string, data: object) => {
//   const supabase = await createClientServer();
//   const { error } = await supabase.from(table).insert([data]);

//   if (error) {
//     console.error(`Error saving to ${table}:`, error);
//     return { success: false, message: `Error saving ${table}` };
//   }
...
//   return await saveCondition("first_condition", {
//     user_id: user,
//     tipe_rumah: dataF.tipeRumah,
//   });
// };
...
//   return await saveCondition("second_condition", {
//     user_id: user,
//     jenis_lantai: dataF.jenisLantai,
//   });
// };
...
//   return await saveCondition("third_condition", {
//     user_id: user,
//     jenis_atap: dataF.jenisAtap,
//   });
// };

// export const submitFinalForm = async (
//   dataStep1: z.infer<typeof firstCondition>,
//   dataStep2: z.infer<typeof secondCondition>,
//   dataStep3: z.infer<typeof thirdCondition>,
//   dataStep4: z.infer<typeof fourthCondition>
// ) => {
//   const supabase = await createClientServer();
//   const { data } = await supabase.auth.getUser();
//   const user = data?.user?.id;
...
//   // Save the fourth condition
//   const saveFourth = await saveCondition("fourth_condition", {
//     user_id: user,
//     jenis_material: dataStep4.jenisMaterial,
//   });

//   if (!saveFourth.success) {
//     return saveFourth;
//   }

//   // Update the existing history record with all selected conditions
//   const { error: historyUpdateError } = await supabase
//     .from("history")
//     .update({
//       tipe_rumah: dataStep1.tipeRumah,
//       jenis_lantai: dataStep2.jenisLantai,
//       jenis_atap: dataStep3.jenisAtap,
//       jenis_material: dataStep4.jenisMaterial,
//     })
//     .eq("user_id", user);
...
//     const supabase = await createClientServer(); // Initialize Supabase client here

//     // Retrieve form values
//     const formData: IFormData = {
//       tipeRumah: (e.target as any).tipeRumah.value,
//       jenisLantai: (e.target as any).jenisLantai.value,
//       jenisAtap: (e.target as any).jenisAtap.value,
//       jenisMaterial: (e.target as any).jenisMaterial.value,
//     };
...
//     // Retrieve the user ID from Supabase
...
//     // Generate a prompt for the AI API
//     const prompt: string = generatePrompt(formData);

//     try {
//       // Call AI API to generate the result based on the form data
//       await handleSubmit(e, {
//         data: { prompt },
//       });
//       // Save conditions to the 'history' table
//       const { error: historyError } = await supabase.from('history').insert({
//         user_id: user,
//         kondisi_1: formData.tipeRumah,
//         kondisi_2: formData.jenisLantai,
//         kondisi_3: formData.jenisAtap,
//         kondisi_4: formData.jenisMaterial,
//       });

//       if (historyError) {
//         console.error("Error saving to history table:", historyError);
//         return;
//       }
...
//       if (resultError) {
//         console.error("Error saving to result table:", resultError);
//         return;
//       }
...
//   return { messages, handleFormSubmit, handleInputChange, input };
// };


const halo : string = "ini adalah string";